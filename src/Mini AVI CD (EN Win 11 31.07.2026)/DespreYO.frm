...
Begin VB.Form DespreYO 
   ...
   Begin VB.Image Image1 
      Height          =   1230
      Left            =   2160
      MouseIcon       =   "DespreYO.frx":3D51
      MousePointer    =   99  'Custom
      Picture         =   "DespreYO.frx":461B
      ToolTipText     =   "Exit"
      Top             =   600
      Width           =   1320
   End
   ...
   Begin VB.Label Label3 
      BackStyle       =   0  'Transparent
      Caption         =   "Novus Ordo , Anno Domini 2026"
      ForeColor       =   &H000000C0&
      Height          =   255
      Left            =   1680
      TabIndex        =   1
...
If Button = 1 Then
Call ReleaseCapture
lngReturnValue = SendMessage(Form3.hWnd, WM_NCLBUTTONDOWN, HTCAPTION, 0&)
End If
End Sub
