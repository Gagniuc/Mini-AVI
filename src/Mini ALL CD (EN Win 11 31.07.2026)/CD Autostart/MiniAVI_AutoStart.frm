...
Begin VB.Form CD_Start 
   ...
   Begin VB.Label Misca_forma 
      ...
      Caption         =   "Mini AVI - CD Autostart V2.1"
      BeginProperty Font 
   ...
   Begin VB.Label Label5 
      BackStyle       =   0  'Transparent
      Caption         =   "Folder where the CD image will be created:"
      ForeColor       =   &H00800000&
      Height          =   255
      Left            =   720
      TabIndex        =   11
...
Dim tmp As String
CD2.Filter = "All files (*.*)|*.*|Known video files|*.mpg;*.mpeg;*.avi;*.wmv;*.asf;*.mp4;*.mkv;*.mov;*.m4v;*.flv;*.divx;*.ts;*.webm|Fisiere mpg (*.mpg)|*.mpg|Fisiere mpeg (*.mpeg)|*.mpeg|Fisiere AVI (*.avi)|*.avi"
...
MsgBox "File - " & Iconita.Text & " does not exist!"
End If

If FileExist(AVI.Text) = False Then
MsgBox "File - " & AVI.Text & " does not exist!"
End If

If FileExist(Subtitrare.Text) = False Then
MsgBox "File - " & Subtitrare.Text & " does not exist!"
End If
...
MsgBox "The master image was not generated. (delete the old master, or change the folder where the image will be generated)"
Exit Sub
End If
Fisierul_INI
Fisierul_KHZ
...
If TitlulFilmului.Text = "" And Iconita.Text = "" And Subtitrare.Text = "" And AVI.Text = "" Then
MsgBox "Please fill in all the data required by the program!"
...
MsgBox "Enter the movie title!"
TitlulFilmului.BackColor = &HFF0000
Exit Sub
End If

If Iconita.Text = "" Then
MsgBox "Choose the CD icon!"
Iconita.BackColor = &HFF0000
Exit Sub
End If

If AVI.Text = "" Then
MsgBox "Choose the movie file!"
AVI.BackColor = &HFF0000
Exit Sub
End If

If Subtitrare.Text = "" Then
MsgBox "Choose the subtitle file!"
Subtitrare.BackColor = &HFF0000
Exit Sub
End If
...
naspa:
foarte_naspa = True
MsgBox "The folders already exist! Change the location where the master image is generated."
Exit Function
4:
End Function
...
Asteapta.Caption = "Please wait ..."
Oglinda2.Caption = "Please wait ..."
...
Asteapta.Caption = "Master image generated!"
Oglinda2.Caption = "Master image generated!"
...
'Un buffer mai mare e mai bun dar nu tre' sa depasesc 64k
   ...
   If Len(Dir(dst)) Then
      If MsgBox(UCase(dst) & Chr(13) & Chr(10) & "File already exists! " & vbCrLf & vbCrLf & "Overwrite the file?", 4) <> 6 Then Exit Function
      Kill dst
   End If
...
Eruare:
   MsgBox "The file could not be copied!"
   Close F1
   Close F2
