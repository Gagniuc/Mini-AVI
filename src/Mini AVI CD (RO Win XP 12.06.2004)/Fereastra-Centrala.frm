...
Begin VB.Form MiniAVI 
   ...
   Begin VB.PictureBox voldisp 
      ...
      Begin VB.Image StopSunet 
         Height          =   255
         Left            =   240
         ToolTipText     =   "Sunet pornit/oprit(Mute)"
         Top             =   360
         Width           =   135
      End
   End
   ...
   Begin VB.Label MarireEcran 
      ...
      Left            =   2640
      TabIndex        =   16
      ToolTipText     =   "Full Screen(Marire ecran)"
      Top             =   855
      Width           =   1335
   End
...
Else
MsgBox "Fisierul video pe care MiniAVI trebuie sa il deschida, nu exista ! Stergeti fisierul MiniAVI.khz !.", vbCritical
End If
End If
ExtractSubtitrare
Umplere_Variabila
...
If Command <> "" Then
    ...
    Else
        MsgBox "Fisierul nu poate fi rulat !", vbCritical
    End If
End If
